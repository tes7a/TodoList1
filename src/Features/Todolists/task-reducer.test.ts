...
beforeEach(() => {
    startState = {
        ...
        "todolistId2": [
            {
                id: '1', title: "beard", status: TaskStatuses.New, todoListId: 'todolistId2', description: '',
                startDate: '', deadline: '', addedDate: '', order: 0, priority: TaskPriorities.Low
            },
            {
...
test('status of specified task should be changed', () => {
   const action = updateTaskAC({taskId: '1', model: {status: TaskStatuses.New}, todolistId: 'todolistId2'});
